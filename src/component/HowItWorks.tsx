        ...
        <div className="container mx-auto border border-gray-800 rounded-xl p-12 backdrop-blur-sm bg-black/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass bento-card rounded-3xl p-8 text-center">
              <div className="text-5xl mb-6 flex justify-center"><FaCamera className="mx-auto" /></div>
            ...
            <div className="glass bento-card rounded-3xl p-8 text-center">
              <div className="text-5xl mb-6 flex justify-center"><GiClothes className="mx-auto" /></div>
              <h3 className="text-2xl font-bold mb-4">2. Choose Outfits</h3>
              <p className="text-gray-400">Browse thousands of clothing items from your favorite brands</p>
            </div>
            
            <div className="glass bento-card rounded-3xl p-8 text-center">
              <div className="text-5xl mb-6 flex justify-center"><FaMagic className="mx-auto" /></div>
